  ...
  <DialogPortal>
    ...
    <DialogPrimitive.Content
      ...
      onPointerDownOutside={(e) => {
        // Prevent closing when clicking on popovers (like calendar or selects)
...
const DialogHeader = ({
  ...
  <div
    className={cn("flex flex-col space-y-1.5 text-center sm:text-left rtl:text-right", className)}
    {...props}
  />
)
